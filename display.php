...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <img class="img-fluid" src="images_pizza/<?php echo $pizza_details['NROPIZZ']; ?>.jpg" alt="Pizza Image">
        </div>
        <div class="col-md-6">
            <h2><?php echo $pizza_details['DESIGNPIZZ']; ?></h2>
            <p><strong>Prix :</strong> <?php echo $pizza_details['TARIFPIZZ']; ?> euros</p>
            <!-- Ajoutez d'autres détails ici en fonction de votre base de données -->
        </div>
    </div>
</div>
