...
<div class="container">
    ...
    <div class="mb-3">
            ...
            <input class="form-control me-2" type="text" name="nom_cli" value="<?php echo $cli_details['NOMCLIE']; ?>" required>
        </div>
        <div class="mb-3">
            <label for="prenom_livr" class="form-label">Prenom :</label>
            <input class="form-control me-2" type="text" name="prenom_cli" value="<?php echo $cli_details['PRENOMCLIE']; ?>"required>
        </div>
        <div class="mb-3">
            <label for="date_livr" class="form-label">Adresse :</label>
            <input class="form-control me-2" type="text" name="adresse_cli" value="<?php echo $cli_details['ADRESSECLIE']; ?>"required>
        </div>
        <div class="mb-3">
            <label for="nom_livr" class="form-label">Ville :</label>
            <input class="form-control me-2" type="text" name="ville_cli" value="<?php echo $cli_details['VILLECLIE']; ?>"required>
        </div>
        <div class="mb-3">
            <label for="nom_livr" class="form-label">Code Postal :</label>
            <input class="form-control me-2" type="text" name="cp_cli" value="<?php echo $cli_details['CODEPOSTALCLIE']; ?>"required>
        </div>
        <div class="mb-3">
            <label for="nom_livr" class="form-label">Titre :</label>
            <input class="form-control me-2" type="text" name="titre_cli" value="<?php echo $cli_details['TITRECLIE']; ?>"required>
        </div>
        <div class="mb-3">
            <label for="nom_livr" class="form-label">Telephone :</label>
            <input class="form-control me-2" type="text" name="tel_cli" value="<?php echo $cli_details['NROTELCLIE']; ?>"required>
        </div>
